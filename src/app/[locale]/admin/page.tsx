...
async function ReportsTab({
  ...
  const ac = (k: string) => t(messages, `reports.analytics.${k}`);

  const copy = {
    // legacy fields (used by sub-cards)
    ...
    analytics: {
      title: ac("title"),
      tabOverview: ac("tabOverview"),
      tabPlans: ac("tabPlans"),
      tabItems: ac("tabItems"),
      tabStaff: ac("tabStaff"),
      periodMonth: ac("periodMonth"),
      periodYear: ac("periodYear"),
      periodAll: ac("periodAll"),
      allTime: ac("allTime"),
      yearLabel: ac("yearLabel"),
      kpiPlansTotal: ac("kpiPlansTotal"),
      kpiCompletionRate: ac("kpiCompletionRate"),
      kpiEscalations: ac("kpiEscalations"),
      kpiItemRate: ac("kpiItemRate"),
      chartEvolution: ac("chartEvolution"),
      chartRateTrend: ac("chartRateTrend"),
      ratesTitle: ac("ratesTitle"),
      plansCompleted: ac("plansCompleted"),
      itemsCompleted: ac("itemsCompleted"),
      mandatoryCompleted: ac("mandatoryCompleted"),
      distributionTitle: ac("distributionTitle"),
      insightsTitle: ac("insightsTitle"),
      topStaffTitle: ac("topStaffTitle"),
      escalationsTitle: ac("escalationsTitle"),
      noEscalationsTitle: ac("noEscalationsTitle"),
      noEscalationsBody: ac("noEscalationsBody"),
      completedLabel: ac("completedLabel"),
      openLabel: ac("openLabel"),
      compareLastMonth: ac("compareLastMonth"),
      plansGrowth: ac("plansGrowth"),
      chartLabelCompleted: ac("chartLabelCompleted"),
      chartLabelTotal: ac("chartLabelTotal"),
      chartLabelRate: ac("chartLabelRate"),
      insightExcellent: ac("insightExcellent"),
      insightLow: ac("insightLow"),
      insightEscalations: ac("insightEscalations"),
      insightTopStaff: ac("insightTopStaff"),
      insightOpenPlans: ac("insightOpenPlans"),
      plansBadgeComplete: ac("plansBadgeComplete"),
      plansBadgeInProgress: ac("plansBadgeInProgress"),
      drawerProgress: ac("drawerProgress"),
      drawerCompleted: ac("drawerCompleted"),
      drawerStatusSection: ac("drawerStatusSection"),
      drawerEditSection: ac("drawerEditSection"),
      drawerEmployee: ac("drawerEmployee"),
      drawerDate: ac("drawerDate"),
      drawerObject: ac("drawerObject"),
      drawerLastPerformed: ac("drawerLastPerformed"),
      drawerMarkDoneSection: ac("drawerMarkDoneSection"),
      drawerPerformedDate: ac("drawerPerformedDate"),
      drawerMarkDone: ac("drawerMarkDone"),
      drawerSaving: ac("drawerSaving"),
      drawerSave: ac("drawerSave"),
      drawerOverdueLabel: ac("drawerOverdueLabel"),
      drawerTurnus: ac("drawerTurnus"),
      drawerDuration: ac("drawerDuration"),
      drawerCleaned: ac("drawerCleaned"),
      drawerSection: ac("drawerSection"),
      searchPlaceholder: ac("searchPlaceholder"),
      itemSearchPlaceholder: ac("itemSearchPlaceholder"),
      sortDate: ac("sortDate"),
      sortCompletions: ac("sortCompletions"),
      noPlans: ac("noPlans"),
      noItems: ac("noItems"),
      noStaff: ac("noStaff"),
      staffPlansCompleted: ac("staffPlansCompleted"),
      staffItemsDone: ac("staffItemsDone"),
      subLabelEmployee: ac("subLabelEmployee"),
      exportCsv: ac("exportCsv"),
      filterAll: ac("filterAll"),
      filterComplete: ac("filterComplete"),
      filterOpen: ac("filterOpen"),
      csvEmployee: ac("csvEmployee"),
      csvDate: ac("csvDate"),
      csvStatus: ac("csvStatus"),
      csvDone: ac("csvDone"),
      csvTotal: ac("csvTotal"),
      csvProgress: ac("csvProgress"),
      statusComplete: ac("statusComplete"),
      statusInProgress: ac("statusInProgress"),
    },
  };
